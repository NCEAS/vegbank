    ...
    <tbody>
     <tr>
      <td align="Center" colspan="8" height="10" valign="center">
       <img alt="" border="0" height="10" src="/vegbank/images/pix_clear.gif" width="1"> 
      </td>
     </tr>
     <tr>
      <td align="Left" height="45" valign="Bottom" width="77"> <br>
        <img alt="Resultset download wizard" border="0" height="23" src="/vegbank/images/hdr_file_info.gif" title="Resultset Download Wizard" vspace="2" width="189"> 
      </td>
     </tr>
     <tr>
      <td align="Center" bgcolor="#003366" colspan="8" height="10" valign="Top">
       <img alt="" border="0" height="1" src="/vegbank/images/pix_003366.gif" width="1"> 
      </td>
     </tr>
     <tr>
      <td align="Center" colspan="8" height="10" valign="center">
     ...
     <tr>
      <td width="77"> <img alt="" border="0" height="1" src="/vegbank/images/pix_clear.gif" width="10"> </td>
      <td bgcolor="#cccc99" width="10"> <img alt="" border="0" height="1" src="/vegbank/images/pix_clear.gif" width="10"> </td>
         ...
         <tr>
            <td valign="Top" width="116"> 
              <font color="#23238e" face="Helvetica,Arial,Verdana" size="2">
                <b>Data format<a href="@help-for-download-formats-href@"> <img border="0" src="/vegbank/images/question.gif"></a></b>
              </font> 
            </td>
            <td align="Left" valign="Top" width="229"> 
      ...
      <td width="80"> <img alt="" border="0" height="1" src="/vegbank/images/pix_clear.gif" width="10"> </td>
      <td bgcolor="#cccc99" width="10"> <img alt="" border="0" height="1" src="/vegbank/images/pix_clear.gif" width="10"> </td>
      <td align="Left" valign="Top" width="126"> &nbsp; 
        <!-- download action -->
        <input name="actionDownload" type="image" value="download" border="0" height="19" src="/vegbank/images/btn_download.gif" width="99">
        <br>
      </td>
     </tr>
     <tr>
