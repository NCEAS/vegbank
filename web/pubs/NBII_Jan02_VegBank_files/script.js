...
var gDocTable = new Array(
   ...
   new hrefList("slide0088.htm", 1, 4),
   new hrefList("slide0091.htm", 1, 5),
   new hrefList("slide0006.htm", 1, 6),
   new hrefList("slide0012.htm", 1, 7),
   new hrefList("slide0096.htm", 1, 8),
   new hrefList("slide0013.htm", 1, 9),
   new hrefList("slide0015.htm", 1, 10),
   new hrefList("slide0029.htm", 1, 11),
   new hrefList("slide0030.htm", 1, 12),
   new hrefList("slide0085.htm", 1, 13),
   new hrefList("slide0031.htm", 1, 14),
   new hrefList("slide0094.htm", 1, 15),
   new hrefList("slide0037.htm", 1, 16),
   new hrefList("slide0076.htm", 1, 17),
   new hrefList("slide0077.htm", 1, 18),
   new hrefList("slide0078.htm", 1, 19),
   new hrefList("slide0079.htm", 1, 20),
   new hrefList("slide0080.htm", 1, 21),
   new hrefList("slide0081.htm", 1, 22),
   new hrefList("slide0097.htm", 1, 23),
   new hrefList("slide0082.htm", 1, 24),
   new hrefList("slide0075.htm", 1, 25),
   new hrefList("slide0086.htm", 1, 26),
   new hrefList("slide0070.htm", 1, 27),
   new hrefList("slide0095.htm", 1, 28),
   new hrefList("slide0069.htm", 1, 29),
   new hrefList("slide0087.htm", 1, 30)
);
