...
<!-- link to taxonObs view -->
         ...
         <td class="taxobs_authorplantname largefield hidden"><a href="@get_link@std/taxonobservation/<bean:write name='onerowoftaxonimportance' property='taxonobservation_id' />">
                          <bean:write name='onerowoftaxonimportance' property='authorplantname' /> </a></td>
         <td class="taxobs_orig_scinamewithauth largefield hidden"><a href="@get_link@std/taxonobservation/<bean:write name='onerowoftaxonimportance' property='taxonobservation_id' />">
         ...
         <td class="taxobs_orig_scinamenoauth largefield hidden"><a href="@get_link@std/taxonobservation/<bean:write name='onerowoftaxonimportance' property='taxonobservation_id' />">
         ...
         <td class="taxobs_orig_code largefield hidden"><a href="@get_link@std/taxonobservation/<bean:write name='onerowoftaxonimportance' property='taxonobservation_id' />">
         ...
         <td class="taxobs_orig_common largefield hidden"><a href="@get_link@std/taxonobservation/<bean:write name='onerowoftaxonimportance' property='taxonobservation_id' />">
         ...
         <td class="taxobs_curr_scinamewithauth largefield hidden"><a href="@get_link@std/taxonobservation/<bean:write name='onerowoftaxonimportance' property='taxonobservation_id' />">
         ...
         <td class="taxobs_curr_code largefield hidden"><a href="@get_link@std/taxonobservation/<bean:write name='onerowoftaxonimportance' property='taxonobservation_id' />">
         ...
         <td class="taxobs_curr_common largefield hidden"><a href="@get_link@std/taxonobservation/<bean:write name='onerowoftaxonimportance' property='taxonobservation_id' />">
