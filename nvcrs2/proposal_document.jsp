...
<script language="javascript" >
	...
	{
		document.proposal_document.submit();
	}
...
<%
		...
		{
%>
			<FORM ACTION="/nvcrs/proposal.go?target=document&act=upload" METHOD="POST" ENCTYPE="multipart/form-data" name="proposal_document">
    		...
    		<TR bgcolor="#cacaca">	
				...
				%>
					...
					<td width =60 align=center><a href="proposal.go?target=document&act=delete&id=1"><img src="image/delete.gif" /></a></td>
				<%
					}
					else
					{
			...
			<TR bgcolor="#d8d8d8">	
				...
				%>
					...
					<td width =60 align=center><a href="proposal.go?target=document&act=delete&id=2"><img src="image/delete.gif" /></a></td>
				<%
					}
					else
					{
			...
			<TR bgcolor="#cacaca">	
				...
				%>
					...
					<td width =60 align=center><a href="proposal.go?target=document&act=delete&id=3"><img src="image/delete.gif" /></a></td>
				<%
					}
					else
					{
