...
<%
	...
	lookup_eventtype_Form fr=(lookup_eventtype_Form)pageContext.getAttribute("lookup_eventtype_form", PageContext.SESSION_SCOPE);
...
%>
	<center>
	<TABLE border="0" >
	<CAPTION><EM>lookup_eventtypes</EM></CAPTION>
	<TR>
		<TH bgcolor="#aacc00">Select
		<TH bgcolor="#ccffcc">type
...
<%
	...
	for(i=0;i<num;i++)
	{
		...
		String type=(String)tb.get("type");
		if(type.length()>40) type=type.substring(0,40)+" ...";
		String id=(String)tb.get(primaryKey);

	    int intAction=manager.getPermissionByRecord("lookup_eventtype",primaryKey,id);
...
int intAction=manager.getPermissionByRecord("lookup_eventtype",primaryKey,primaryKeyValue);
if(intAction==0)
{
%>
	<tr>
...
<form name="hideform" method="post" action="/nvcrs/lookup_eventtypes.go">
