...
%>
	<center>
	<TABLE border="0" >
	<CAPTION><EM>lookup_roletypes</EM></CAPTION>
	<TR>
...
<%
	...
	for(i=0;i<num;i++)
	{
	    ...
	    int intAction=manager.getPermissionByRecord("lookup_roletype",primaryKey,id);
...
<form name="hideform" method="post" action="/nvcrs/lookup_roletypes.go">
