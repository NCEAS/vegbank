...
<%
		...
		{
%>
			<FORM ACTION="/nvcrs/project.go?target=document&act=upload" METHOD="POST" ENCTYPE="multipart/form-data" name="project_document">
			<table width=600 border=0 cellpadding=0 cellspacing=0 bgcolor="#ecedcd">
    		 <tr><th colspan=1 background="image/blue_back.gif"><center><font color=white>Project Documents</font></center></th>
		     <tr><td>&nbsp;</td></tr>
    		<tr><td align=center>
    		...
    		<TR bgcolor="#cacaca">	
				...
				%>
					...
					<td width =60 align=center><a href="project.go?target=document&act=delete&id=1"><img src="image/delete.gif" /></a></td>
				<%
					}
					else
					{
			...
			<TR bgcolor="#d8d8d8">	
				...
				%>
					...
					<td width =60 align=center><a href="project.go?target=document&act=delete&id=2"><img src="image/delete.gif" /></a></td>
				<%
					}
					else
					{
			...
			<TR bgcolor="#cacaca">	
				...
				%>
					...
					<td width =60 align=center><a href="project.go?target=document&act=delete&id=3"><img src="image/delete.gif" /></a></td>
				<%
					}
					else
					{
