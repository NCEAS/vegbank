...
%>
		<TH background="image/blue_back.gif" align=center valign=center ><font size=2 color=white>Plant name
		<TH background="image/blue_back.gif"  align=center valign=center><font size=2 color=white>Constancy
		<TH background="image/blue_back.gif" align=center valign=center ><font size=2 color=white>Stratum
...
<%
	...
	for(i=0;i<num;i++)
	{
		...
		String VBPlant_AccessionCode=(String)tb.get("VBPlant_AccessionCode");
		if(VBPlant_AccessionCode.length()>40) VBPlant_AccessionCode=VBPlant_AccessionCode.substring(0,40)+" ...";
		String constancy=(String)tb.get("constancy");
		if(constancy.length()>40) constancy=constancy.substring(0,40)+" ...";
		String compositionType=(String)tb.get("compositionType");
		if(compositionType.length()>40) compositionType=compositionType.substring(0,40)+" ...";
		String notes=(String)tb.get("notes");
		if(notes.length()>40) notes=notes.substring(0,40)+" ...";
		String stratum=(String)tb.get("stratum");
		if(stratum.length()>40) stratum=stratum.substring(0,40)+" ...";
		String VBMethod_AccessionCode=(String)tb.get("VBMethod_AccessionCode");
		if(VBMethod_AccessionCode.length()>40) VBMethod_AccessionCode=VBMethod_AccessionCode.substring(0,40)+" ...";
...
%>
		...
		<TD align=center valign=center><font size=2><%= VBPlant_AccessionCode %>
		<TD align=center valign=center><font size=2><%= constancy %>
		<TD align=center valign=center><font size=2><%= stratum %>
...
%>
<br><br>
<form name="hideform" method="post" action="/nvcrs/compositions.go">
