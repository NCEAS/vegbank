...
%>
		<TH background="image/blue_back.gif"  align=center valign=center><font size=2 color=white>Name
		<TH background="image/blue_back.gif"  align=center valign=center><font size=2 color=white>Name system
		<TH background="image/blue_back.gif"  align=center valign=center><font size=2 color=white>Status
<!--		<TH background="image/blue_back.gif"  align=center valign=center><font size=2 color=white>Start date
		<TH background="image/blue_back.gif"  align=center valign=center><font size=2 color=white>Stop date -->
...
<%
	...
	for(i=0;i<num;i++)
	{
		...
		String typeName=(String)tb.get("typeName");
		if(typeName.length()>40) typeName=typeName.substring(0,40)+" ...";
		String typeNameSystem=(String)tb.get("typeNameSystem");
		if(typeNameSystem.length()>40) typeNameSystem=typeNameSystem.substring(0,40)+" ...";
		String typeNameStatus=(String)tb.get("typeNameStatus");
		if(typeNameStatus.length()>40) typeNameStatus=typeNameStatus.substring(0,40)+" ...";
		String startDate=(String)tb.get("startDate");
		if(startDate.length()>40) startDate=startDate.substring(0,40)+" ...";
		String stopDate=(String)tb.get("stopDate");
		if(stopDate.length()>40) stopDate=stopDate.substring(0,40)+" ...";
...
%>
		<TD align=center valign=center><font size=2><%= typeName %>
		<TD align=center valign=center><font size=2><%= typeNameSystem %>
		<TD align=center valign=center><font size=2><%= typeNameStatus %>
<!--		<TD align=center valign=center><font size=2><%= startDate %>
		<TD align=center valign=center><font size=2><%= stopDate %> -->
...
%>
<br><br>
<form name="hideform" method="post" action="/nvcrs/typenames.go">
