...
public class DBConnect
{
	...
	static public void main(String[] args)
	{
		...
		System.out.println(
			"This class reads a file called \"database.properties\""
		...
		{
			System.out.println(
				"failed calling dbConnect.makeConnection" + " call" + e.getMessage());
		}
	...
	public void makeConnection(Connection conn, Statement query)
	{
		...
		*/
		...
		DBConnect m = new DBConnect();
		m.getParameters("database.properties");
		//assume that the parameters file is local to the class
	...
	private void getParameters(String inputFile)
	{
		...
		{
			System.out.println(
				"failed in class: dbConnect.getParameters, trying "
					+ "to read the database parameter file: database.properties "
					+ e.getMessage());
		}
