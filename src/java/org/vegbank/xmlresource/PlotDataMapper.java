...
public class PlotDataMapper 
{
	...
	public Vector taxonNameElements= new Vector();
	public Vector cumStrataCoverElements= new Vector();
	public Vector strataTypeElements = new Vector();
	public Vector coverAmountElements = new Vector();

	public Vector stratumNameElements = new Vector();  //recognized strata names
	public Vector stratumHeightElements = new Vector(); //recognized strata heights
	public Vector stratumCoverElements = new Vector(); //recognized strata cover vals

	//project specific information
	public Hashtable plotProjectParams = new Hashtable();
	//plot specific site information
	public Hashtable plotSiteParams = new Hashtable();
	//plot observation specific information
	public Hashtable plotObservationParams = new Hashtable();
	//species specific site information
	public Hashtable plotSpeciesParams = new Hashtable();
	//community specific information
	public Hashtable plotCommunityParams = new Hashtable();

	// this is the hash that contains all the elements and will be passed to 
	// the writer method
	public Hashtable comprehensivePlot = new Hashtable();
