...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="VegBankPackage">HD,tableName,field1,field2,field3,field4,field5,field6,field7,field8,field9,field10,field11,field12,field13,field14,field15,field16,field17,field18,field19,field20,field21,field22,field23,field24,field25,field26,field27,field28,field29,field30,field31,field32,field33,field34,field35,field36,field37,field38,field39,field40,field41,field42,field43,field44,field45,field46,field47,field48,field49,field50,field51,field52,field53,field54,field55,field56,field57,field58,field59,field60,field61,field62,field63,field64,field65,field66,field67,field68,field69,field70,field71,field72,field73,field74<xsl:value-of select="$LF" />"H",<xsl:call-template name="csvIt">
      ...
      <xsl:with-param name="text">plantCode</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      ...
      <xsl:with-param name="text">plantParentName</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">plantParentConcept_id</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      ...
      <xsl:with-param name="text">PARTY_ID</xsl:with-param>
    </xsl:call-template>,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null<xsl:value-of select="$LF" />"H",<xsl:call-template name="csvIt">
      ...
      <xsl:with-param name="text">acceptedSynonym</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">PARTY_ID</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">PLANTSTATUS_ID</xsl:with-param>
      ...
      <xsl:with-param name="text">roleProject</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">roleObservation</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">roleTaxonInt</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">roleClassInt</xsl:with-param>
      ...
      <xsl:with-param name="text">accessionCode</xsl:with-param>
    </xsl:call-template>,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null<xsl:value-of select="$LF" />"H",<xsl:call-template name="csvIt">
      ...
      <xsl:with-param name="text">commCode</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">commFramework</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">commLevel</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">accessionCode</xsl:with-param>
      ...
      <xsl:with-param name="text">stateProvince</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">country</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">dateentered</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">submitter_surname</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">submitter_givenname</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">submitter_email</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">accessionCode</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">notesPublic</xsl:with-param>
      ...
      <xsl:with-param name="text">revisions</xsl:with-param>
    </xsl:call-template>,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null<xsl:value-of select="$LF" />"H",<xsl:call-template name="csvIt">
      ...
      <xsl:with-param name="text">cheatRole</xsl:with-param>
    </xsl:call-template>,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null<xsl:value-of select="$LF" />"H",<xsl:call-template name="csvIt">
    ...
    </xsl:call-template>,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null<xsl:value-of select="$LF" />"H",<xsl:call-template name="csvIt">
      ...
      <xsl:with-param name="text">usr</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">usr_ID</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">party_ID</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">password</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">permission_type</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">begin_time</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">last_connect</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">ticket_count</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">email_address</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">preferred_name</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">remote_address</xsl:with-param>
    </xsl:call-template>,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null<xsl:value-of select="$LF" />"H",<xsl:call-template name="csvIt">
      <xsl:with-param name="text">userCertification</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">userCertification_ID</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">usr_ID</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">current_cert_level</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">requested_cert_level</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">highest_degree</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">degree_year</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">degree_institution</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">current_org</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">current_pos</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">esa_member</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">prof_exp</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">relevant_pubs</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">veg_sampling_exp</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">veg_analysis_exp</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">usnvc_exp</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">vb_exp</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">vb_intention</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">tools_exp</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">esa_sponsor_name_a</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">esa_sponsor_email_a</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">esa_sponsor_name_b</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">esa_sponsor_email_b</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">peer_review</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">addl_stmt</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">certificationStatus</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">certificationStatusComments</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">exp_region_a</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">exp_region_b</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">exp_region_c</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">exp_region_a_veg</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">exp_region_b_veg</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">exp_region_c_veg</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">exp_region_a_flor</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">exp_region_b_flor</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">exp_region_c_flor</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">exp_region_a_nvc</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">exp_region_b_nvc</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">exp_region_c_nvc</xsl:with-param>
    </xsl:call-template>,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null<xsl:value-of select="$LF" />"H",<xsl:call-template name="csvIt">
      <xsl:with-param name="text">userRegionalExp</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">userRegionalExp_ID</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">userCertification_ID</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">region</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">vegetation</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">floristics</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">nvc_ivc</xsl:with-param>
    </xsl:call-template>,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null<xsl:value-of select="$LF" />"H",<xsl:call-template name="csvIt">
      <xsl:with-param name="text">userDataset</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">userDataset_ID</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">usr_ID</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">datasetStart</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">datasetStop</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">accessionCode</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">datasetName</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">datasetDescription</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">datasetType</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">datasetSharing</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">datasetPassword</xsl:with-param>
    </xsl:call-template>,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null<xsl:value-of select="$LF" />"H",<xsl:call-template name="csvIt">
      <xsl:with-param name="text">userDatasetItem</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">userDatasetItem_ID</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">userDataset_ID</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">itemAccessionCode</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">itemType</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">itemStart</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">itemStop</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">notes</xsl:with-param>
    </xsl:call-template>,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null<xsl:value-of select="$LF" />"H",<xsl:call-template name="csvIt">
      <xsl:with-param name="text">userNotify</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">userNotify_ID</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">usr_ID</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">notifyName</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">notifyDescription</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">notifyStart</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">notifyStop</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">lastCheckDate</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">notifySQL</xsl:with-param>
    </xsl:call-template>,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null<xsl:value-of select="$LF" />"H",<xsl:call-template name="csvIt">
      <xsl:with-param name="text">userPermission</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">userPermission_ID</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">embargo_ID</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">usr_ID</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">permissionStart</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">permissionStop</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">permissionStatus</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">permissionNotes</xsl:with-param>
    </xsl:call-template>,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null<xsl:value-of select="$LF" />"H",<xsl:call-template name="csvIt">
      <xsl:with-param name="text">userQuery</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">userQuery_ID</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">usr_ID</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">queryStart</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">queryStop</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">accessionCode</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">queryName</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">queryDescription</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">querySQL</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">queryType</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">querySharing</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">queryPassword</xsl:with-param>
    </xsl:call-template>,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null<xsl:value-of select="$LF" />"H",<xsl:call-template name="csvIt">
      <xsl:with-param name="text">userPreference</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">userPreference_ID</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">usr_ID</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">preferenceName</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">preferenceValue</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">preferencePriority</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">preferenceStart</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">preferenceStop</xsl:with-param>
    </xsl:call-template>,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null<xsl:value-of select="$LF" />"H",<xsl:call-template name="csvIt">
      <xsl:with-param name="text">userRecordOwner</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">userRecordOwner_ID</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">usr_ID</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">tableName</xsl:with-param>
      ...
      <xsl:with-param name="text">recordCreationDate</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">ownerStart</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">ownerStop</xsl:with-param>
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text">ownerType</xsl:with-param>
  ...
  <xsl:template match="commUsage">
    <xsl:value-of select="$LF" />"d",<xsl:call-template name="csvIt">
      ...
      <xsl:with-param name="text" select="commUsage.commName" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="../commConcept.COMMCONCEPT_ID" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      ...
      <xsl:with-param name="text" select="commUsage.PARTY_ID/party/party.PARTY_ID" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="commUsage.COMMSTATUS_ID/commStatus/commStatus.COMMSTATUS_ID" />
    </xsl:call-template>,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null<xsl:apply-templates />
  </xsl:template>
  ...
  <xsl:template match="commUsage.commName" />
  <xsl:template match="commUsage.COMMCONCEPT_ID" />
  ...
  <xsl:template match="commUsage.PARTY_ID">
    <xsl:apply-templates />
  </xsl:template>
  ...
  <xsl:template match="plantConcept">
    <xsl:value-of select="$LF" />"d",<xsl:call-template name="csvIt">
      ...
      <xsl:with-param name="text" select="plantConcept.plantname" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="plantConcept.plantCode" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
  ...
  <xsl:template match="plantConcept.plantname" />
  <xsl:template match="plantConcept.plantCode" />
  ...
  <xsl:template match="plantStatus">
    <xsl:value-of select="$LF" />"d",<xsl:call-template name="csvIt">
      ...
      <xsl:with-param name="text" select="plantStatus.plantParentName" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="plantStatus.plantParentConcept_id" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
    ...
    </xsl:call-template>,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null<xsl:apply-templates />
  </xsl:template>
  ...
  <xsl:template match="plantStatus.plantParentName" />
  <xsl:template match="plantStatus.plantParentConcept_id" />
  ...
  <xsl:template match="plantUsage">
    <xsl:value-of select="$LF" />"d",<xsl:call-template name="csvIt">
      ...
      <xsl:with-param name="text" select="plantUsage.plantName" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="plantUsage.classSystem" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="plantUsage.acceptedSynonym" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="plantUsage.PARTY_ID/party/party.PARTY_ID" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="plantUsage.PLANTSTATUS_ID/plantStatus/plantStatus.PLANTSTATUS_ID" />
  ...
  <xsl:template match="plantUsage.PLANTCONCEPT_ID" />
  ...
  <xsl:template match="plantUsage.plantName" />
  <xsl:template match="plantUsage.classSystem" />
  <xsl:template match="plantUsage.acceptedSynonym" />
  <xsl:template match="plantUsage.PARTY_ID">
    <xsl:apply-templates />
  </xsl:template>
  ...
  <xsl:template match="aux_Role">
    <xsl:value-of select="$LF" />"d",<xsl:call-template name="csvIt">
      ...
      <xsl:with-param name="text" select="aux_Role.roleProject" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="aux_Role.roleObservation" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="aux_Role.roleTaxonInt" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="aux_Role.roleClassInt" />
    </xsl:call-template>,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null<xsl:apply-templates />
  </xsl:template>
  ...
  <xsl:template match="aux_Role.roleProject" />
  <xsl:template match="aux_Role.roleObservation" />
  <xsl:template match="aux_Role.roleTaxonInt" />
  <xsl:template match="aux_Role.roleClassInt" />
  <xsl:template match="reference">
    ...
    </xsl:call-template>,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null<xsl:apply-templates />
  </xsl:template>
  ...
  <xsl:template match="commClass">
    <xsl:value-of select="$LF" />"d",<xsl:call-template name="csvIt">
      ...
      <xsl:with-param name="text" select="commClass.commName" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="commClass.commCode" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="commClass.commFramework" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="commClass.commLevel" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
  ...
  <xsl:template match="commClass.commName" />
  <xsl:template match="commClass.commCode" />
  <xsl:template match="commClass.commFramework" />
  <xsl:template match="commClass.commLevel" />
  ...
  <xsl:template match="commInterpretation">
    <xsl:value-of select="$LF" />"d",<xsl:call-template name="csvIt">
      ...
      <xsl:with-param name="text" select="commInterpretation.commcode" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="commInterpretation.commname" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
  ...
  <xsl:template match="commInterpretation.commcode" />
  <xsl:template match="commInterpretation.commname" />
  ...
  <xsl:template match="party">
    <xsl:value-of select="$LF" />"d",<xsl:call-template name="csvIt">
      ...
      <xsl:with-param name="text" select="party.email" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
  ...
  <xsl:template match="party.email" />
  ...
  <xsl:template match="plot">
    <xsl:value-of select="$LF" />"d",<xsl:call-template name="csvIt">
      ...
      <xsl:with-param name="text" select="plot.stateProvince" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="plot.country" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="plot.dateentered" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="plot.submitter_surname" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="plot.submitter_givenname" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="plot.submitter_email" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
    ...
    </xsl:call-template>,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null<xsl:apply-templates />
  </xsl:template>
  ...
  <xsl:template match="plot.stateProvince" />
  <xsl:template match="plot.country" />
  <xsl:template match="plot.dateentered" />
  <xsl:template match="plot.submitter_surname" />
  <xsl:template match="plot.submitter_givenname" />
  <xsl:template match="plot.submitter_email" />
  ...
  <xsl:template match="projectContributor">
    <xsl:value-of select="$LF" />"d",<xsl:call-template name="csvIt">
      ...
      <xsl:with-param name="text" select="projectContributor.surname" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="projectContributor.cheatRole" />
    </xsl:call-template>,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null<xsl:apply-templates />
  </xsl:template>
  ...
  <xsl:template match="projectContributor.surname" />
  <xsl:template match="projectContributor.cheatRole" />
  ...
  <xsl:template match="soilObs">
    ...
    </xsl:call-template>,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null<xsl:apply-templates />
  </xsl:template>
  ...
  <xsl:template match="stratum">
    <xsl:value-of select="$LF" />"d",<xsl:call-template name="csvIt">
      ...
      <xsl:with-param name="text" select="stratum.STRATUMMETHOD_ID/stratumMethod/stratumMethod.STRATUMMETHOD_ID" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="stratum.stratumName" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      ...
      <xsl:with-param name="text" select="stratum.stratumDescription" />
  ...
  <xsl:template match="stratum.STRATUMMETHOD_ID">
    <xsl:apply-templates />
  </xsl:template>
  <xsl:template match="stratum.stratumName" />
  <xsl:template match="stratum.stratumHeight" />
  <xsl:template match="stratum.stratumBase" />
  <xsl:template match="stratum.stratumCover" />
  <xsl:template match="stratum.stratumDescription" />
  ...
  <xsl:template match="usr">
    <xsl:value-of select="$LF" />"d",<xsl:call-template name="csvIt">
      ...
      <xsl:with-param name="text" select="usr.usr_ID" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="usr.party_ID/party/party.PARTY_ID" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="usr.password" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="usr.permission_type" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="usr.begin_time" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="usr.last_connect" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="usr.ticket_count" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="usr.email_address" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="usr.preferred_name" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="usr.remote_address" />
    </xsl:call-template>,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null<xsl:apply-templates />
  </xsl:template>
  <xsl:template match="usr.usr_ID" />
  <xsl:template match="usr.party_ID">
    <xsl:apply-templates />
  </xsl:template>
  <xsl:template match="usr.password" />
  <xsl:template match="usr.permission_type" />
  <xsl:template match="usr.begin_time" />
  <xsl:template match="usr.last_connect" />
  <xsl:template match="usr.ticket_count" />
  <xsl:template match="usr.email_address" />
  <xsl:template match="usr.preferred_name" />
  <xsl:template match="usr.remote_address" />
  <xsl:template match="userCertification">
    <xsl:value-of select="$LF" />"d",<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="name()" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.userCertification_ID" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="../usr.usr_ID" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.current_cert_level" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.requested_cert_level" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.highest_degree" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.degree_year" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.degree_institution" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.current_org" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.current_pos" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.esa_member" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.prof_exp" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.relevant_pubs" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.veg_sampling_exp" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.veg_analysis_exp" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.usnvc_exp" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.vb_exp" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.vb_intention" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.tools_exp" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.esa_sponsor_name_a" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.esa_sponsor_email_a" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.esa_sponsor_name_b" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.esa_sponsor_email_b" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.peer_review" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.addl_stmt" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.certificationStatus" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.certificationStatusComments" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.exp_region_a" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.exp_region_b" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.exp_region_c" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.exp_region_a_veg" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.exp_region_b_veg" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.exp_region_c_veg" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.exp_region_a_flor" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.exp_region_b_flor" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.exp_region_c_flor" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.exp_region_a_nvc" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.exp_region_b_nvc" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userCertification.exp_region_c_nvc" />
    </xsl:call-template>,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null<xsl:apply-templates />
  </xsl:template>
  <xsl:template match="userCertification.userCertification_ID" />
  <xsl:template match="userCertification.usr_ID" />
  <xsl:template match="userCertification.current_cert_level" />
  <xsl:template match="userCertification.requested_cert_level" />
  <xsl:template match="userCertification.highest_degree" />
  <xsl:template match="userCertification.degree_year" />
  <xsl:template match="userCertification.degree_institution" />
  <xsl:template match="userCertification.current_org" />
  <xsl:template match="userCertification.current_pos" />
  <xsl:template match="userCertification.esa_member" />
  <xsl:template match="userCertification.prof_exp" />
  <xsl:template match="userCertification.relevant_pubs" />
  <xsl:template match="userCertification.veg_sampling_exp" />
  <xsl:template match="userCertification.veg_analysis_exp" />
  <xsl:template match="userCertification.usnvc_exp" />
  <xsl:template match="userCertification.vb_exp" />
  <xsl:template match="userCertification.vb_intention" />
  <xsl:template match="userCertification.tools_exp" />
  <xsl:template match="userCertification.esa_sponsor_name_a" />
  <xsl:template match="userCertification.esa_sponsor_email_a" />
  <xsl:template match="userCertification.esa_sponsor_name_b" />
  <xsl:template match="userCertification.esa_sponsor_email_b" />
  <xsl:template match="userCertification.peer_review" />
  <xsl:template match="userCertification.addl_stmt" />
  <xsl:template match="userCertification.certificationStatus" />
  <xsl:template match="userCertification.certificationStatusComments" />
  <xsl:template match="userCertification.exp_region_a" />
  <xsl:template match="userCertification.exp_region_b" />
  <xsl:template match="userCertification.exp_region_c" />
  <xsl:template match="userCertification.exp_region_a_veg" />
  <xsl:template match="userCertification.exp_region_b_veg" />
  <xsl:template match="userCertification.exp_region_c_veg" />
  <xsl:template match="userCertification.exp_region_a_flor" />
  <xsl:template match="userCertification.exp_region_b_flor" />
  <xsl:template match="userCertification.exp_region_c_flor" />
  <xsl:template match="userCertification.exp_region_a_nvc" />
  <xsl:template match="userCertification.exp_region_b_nvc" />
  <xsl:template match="userCertification.exp_region_c_nvc" />
  <xsl:template match="userRegionalExp">
    <xsl:value-of select="$LF" />"d",<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="name()" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userRegionalExp.userRegionalExp_ID" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="../userCertification.userCertification_ID" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userRegionalExp.region" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userRegionalExp.vegetation" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userRegionalExp.floristics" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userRegionalExp.nvc_ivc" />
    </xsl:call-template>,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null<xsl:apply-templates />
  </xsl:template>
  <xsl:template match="userRegionalExp.userRegionalExp_ID" />
  <xsl:template match="userRegionalExp.userCertification_ID" />
  <xsl:template match="userRegionalExp.region" />
  <xsl:template match="userRegionalExp.vegetation" />
  <xsl:template match="userRegionalExp.floristics" />
  <xsl:template match="userRegionalExp.nvc_ivc" />
  <xsl:template match="userDataset">
    <xsl:value-of select="$LF" />"d",<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="name()" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userDataset.userDataset_ID" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="../usr.usr_ID" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userDataset.datasetStart" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userDataset.datasetStop" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userDataset.accessionCode" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userDataset.datasetName" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userDataset.datasetDescription" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userDataset.datasetType" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userDataset.datasetSharing" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userDataset.datasetPassword" />
    </xsl:call-template>,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null<xsl:apply-templates />
  </xsl:template>
  <xsl:template match="userDataset.userDataset_ID" />
  <xsl:template match="userDataset.usr_ID" />
  <xsl:template match="userDataset.datasetStart" />
  <xsl:template match="userDataset.datasetStop" />
  <xsl:template match="userDataset.accessionCode" />
  <xsl:template match="userDataset.datasetName" />
  <xsl:template match="userDataset.datasetDescription" />
  <xsl:template match="userDataset.datasetType" />
  <xsl:template match="userDataset.datasetSharing" />
  <xsl:template match="userDataset.datasetPassword" />
  <xsl:template match="userDatasetItem">
    <xsl:value-of select="$LF" />"d",<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="name()" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userDatasetItem.userDatasetItem_ID" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="../userDataset.userDataset_ID" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userDatasetItem.itemAccessionCode" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userDatasetItem.itemType" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userDatasetItem.itemStart" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userDatasetItem.itemStop" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userDatasetItem.notes" />
    </xsl:call-template>,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null<xsl:apply-templates />
  </xsl:template>
  <xsl:template match="userDatasetItem.userDatasetItem_ID" />
  <xsl:template match="userDatasetItem.userDataset_ID" />
  <xsl:template match="userDatasetItem.itemAccessionCode" />
  <xsl:template match="userDatasetItem.itemType" />
  <xsl:template match="userDatasetItem.itemStart" />
  <xsl:template match="userDatasetItem.itemStop" />
  <xsl:template match="userDatasetItem.notes" />
  <xsl:template match="userNotify">
    <xsl:value-of select="$LF" />"d",<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="name()" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userNotify.userNotify_ID" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="../usr.usr_ID" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userNotify.notifyName" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userNotify.notifyDescription" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userNotify.notifyStart" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userNotify.notifyStop" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userNotify.lastCheckDate" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userNotify.notifySQL" />
    </xsl:call-template>,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null<xsl:apply-templates />
  </xsl:template>
  <xsl:template match="userNotify.userNotify_ID" />
  <xsl:template match="userNotify.usr_ID" />
  <xsl:template match="userNotify.notifyName" />
  <xsl:template match="userNotify.notifyDescription" />
  <xsl:template match="userNotify.notifyStart" />
  <xsl:template match="userNotify.notifyStop" />
  <xsl:template match="userNotify.lastCheckDate" />
  <xsl:template match="userNotify.notifySQL" />
  <xsl:template match="userPermission">
    <xsl:value-of select="$LF" />"d",<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="name()" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userPermission.userPermission_ID" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="../embargo.embargo_ID" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userPermission.usr_ID/usr/usr.usr_ID" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userPermission.permissionStart" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userPermission.permissionStop" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userPermission.permissionStatus" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userPermission.permissionNotes" />
    </xsl:call-template>,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null<xsl:apply-templates />
  </xsl:template>
  <xsl:template match="userPermission.userPermission_ID" />
  <xsl:template match="userPermission.embargo_ID" />
  <xsl:template match="userPermission.usr_ID">
    <xsl:apply-templates />
  </xsl:template>
  <xsl:template match="userPermission.permissionStart" />
  <xsl:template match="userPermission.permissionStop" />
  <xsl:template match="userPermission.permissionStatus" />
  <xsl:template match="userPermission.permissionNotes" />
  <xsl:template match="userQuery">
    <xsl:value-of select="$LF" />"d",<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="name()" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userQuery.userQuery_ID" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="../usr.usr_ID" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userQuery.queryStart" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userQuery.queryStop" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userQuery.accessionCode" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userQuery.queryName" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userQuery.queryDescription" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userQuery.querySQL" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userQuery.queryType" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userQuery.querySharing" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userQuery.queryPassword" />
    </xsl:call-template>,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null<xsl:apply-templates />
  </xsl:template>
  <xsl:template match="userQuery.userQuery_ID" />
  <xsl:template match="userQuery.usr_ID" />
  <xsl:template match="userQuery.queryStart" />
  <xsl:template match="userQuery.queryStop" />
  <xsl:template match="userQuery.accessionCode" />
  <xsl:template match="userQuery.queryName" />
  <xsl:template match="userQuery.queryDescription" />
  <xsl:template match="userQuery.querySQL" />
  <xsl:template match="userQuery.queryType" />
  <xsl:template match="userQuery.querySharing" />
  <xsl:template match="userQuery.queryPassword" />
  <xsl:template match="userPreference">
    <xsl:value-of select="$LF" />"d",<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="name()" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userPreference.userPreference_ID" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="../usr.usr_ID" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userPreference.preferenceName" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userPreference.preferenceValue" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userPreference.preferencePriority" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userPreference.preferenceStart" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userPreference.preferenceStop" />
    </xsl:call-template>,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null<xsl:apply-templates />
  </xsl:template>
  <xsl:template match="userPreference.userPreference_ID" />
  <xsl:template match="userPreference.usr_ID" />
  <xsl:template match="userPreference.preferenceName" />
  <xsl:template match="userPreference.preferenceValue" />
  <xsl:template match="userPreference.preferencePriority" />
  <xsl:template match="userPreference.preferenceStart" />
  <xsl:template match="userPreference.preferenceStop" />
  <xsl:template match="userRecordOwner">
    <xsl:value-of select="$LF" />"d",<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="name()" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userRecordOwner.userRecordOwner_ID" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="../usr.usr_ID" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userRecordOwner.tableName" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userRecordOwner.tableRecord" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userRecordOwner.recordCreationDate" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userRecordOwner.ownerStart" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userRecordOwner.ownerStop" />
    </xsl:call-template>,<xsl:call-template name="csvIt">
      <xsl:with-param name="text" select="userRecordOwner.ownerType" />
    </xsl:call-template>,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null<xsl:apply-templates />
  </xsl:template>
  <xsl:template match="userRecordOwner.userRecordOwner_ID" />
  <xsl:template match="userRecordOwner.usr_ID" />
  <xsl:template match="userRecordOwner.tableName" />
  <xsl:template match="userRecordOwner.tableRecord" />
  <xsl:template match="userRecordOwner.recordCreationDate" />
  <xsl:template match="userRecordOwner.ownerStart" />
  <xsl:template match="userRecordOwner.ownerStop" />
  <xsl:template match="userRecordOwner.ownerType" />
</xsl:stylesheet>
