...
if (action.equals("initiate") ) {	
	...
	catch( Exception e ) {System.out.println(" failed in: manageLocalDbConnectionBroker "
		+e.getMessage() );
		e.printStackTrace();
	}
}
...
///	System.out.println("LocalDbConnectionBroker.currentConnectionNum: "+curentConnectionNum);
	...
	} catch( Exception e ) {System.out.println("failed in: manageLocalDbConnectionBroker realease "
	...
	catch( Exception e ) {System.out.println("failed in: manageLocalDbConnectionBroker destroy"
	+e.getMessage() ); e.printStackTrace();}

}
else { System.out.println("LocalDbConnectionBroker.manageLocalDbConnectionBroker: unrecognized action"
+action);}
