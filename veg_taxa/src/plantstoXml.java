...
public class plantstoXml
{
	public static void main(String[] args)
	{
		...
		{
			System.out.println("did not load all the data " + e.getMessage());
		}
		...
		try
		{
			for (int i = 0; i < lineNum; i++)
			{
				...
				if (infileArray[i].indexOf("=") > 0)
				{
					...
					{
						String remaingBuf = t2.nextToken();
						buf = buf + remaingBuf;
					}
					nameAuthor = buf;
				...
				try
				{
					...
					if (synonymType.equals("synonym"))
					{
						...
						out.println("");
						out.println("<status>");
						out.println("<currentStatus>NS</currentStatus>");
						//this is std where there is no equals sign
						out.println("<statusParty>USDA</statusParty>");
						out.println("<startDate>1996</startDate>");
						// edit this for the particular year
						...
						out.println(
							"<correlationDateEntered>2000</correlationDateEntered>");
						out.println(
							"<correlationCitation>Plants 1996: plants.usda.gov</correlationCitation>");
