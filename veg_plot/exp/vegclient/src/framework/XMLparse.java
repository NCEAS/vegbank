...
public class XMLparse
{
	...
	//		DOMwalker walker = new DOMwalker(doc);
		...
		else if (args.length == 3)
		{
			...
			else if (args[0].equals("-pathContent"))
			{
				String option = args[0];
				String filename = args[1];
				String path = args[2];
			...
			else if (args[0].equals("-nodePrint"))
			{
				String option = args[0];
				String filename = args[1];
  ...
  */
  ...
  public Vector getValuesForPath(Document doc, String pathstring) 
   ...
   //   ClientFramework.debug(4, "Error in getValueForPath method");
	 ...
	 * that is returned
	 */
	public String getChildNodeValue(Document doc, String parentNode, String childNode) 
	{
...
//		System.out.println("number of childern nodes: " + nlist.getLength() );
  ...
  public Document set( Document doc, String key, int i, String value)
  {
	 ...
	 */
	public void replaceElement( String fileName, String nodeName, String newNodeValue, String outFile)
	{
			try 
		{
			Document doc = getDocument(fileName);
