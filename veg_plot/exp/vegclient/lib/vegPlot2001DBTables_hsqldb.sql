...
create cached table plotObservation (
...
create cached table strataComposition (
	strataComposition_id INT IDENTITY,
	taxonObservation_id DECIMAL,
	strata_id DECIMAL,
	cheatStratumType VARCHAR(32),
	percentCover DECIMAL
);
create cached table taxonObservation (
...
create cached table communityType (
...
create cached table interpretation (
...
create cached table vegPlotParty (
...
create cached table projectContributor (
...
create cached table plotContributor (
...
create cached table email (
email_id INT NOT NULL PRIMARY KEY,
party_id INT NOT NULL,
emailAddress VARCHAR(32)
);

create cached table onlineResource (
...
create cached table citationContributor (
