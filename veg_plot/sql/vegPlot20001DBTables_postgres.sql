/*
 * vegPlotDB.sql -- Creates the veg plots database -- on the
 * postgresql database 
 */
...
treePlotSize INT,
plotOriginLat NUMERIC(22,6),
plotOriginLong NUMERIC(22,6), 
horizPosAcc NUMERIC(22,6),
plotShape VARCHAR(12),
plotSize VARCHAR(20),
plotSizeAcc NUMERIC(3),
altValue NUMERIC(8),
altPosAcc NUMERIC(3),
