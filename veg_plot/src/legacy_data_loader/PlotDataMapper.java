...
Vector cumStrataCoverElements = new Vector(); //recognized strata cover vals
...
//store plot observational data -- which may include strata information
 ...
 {
//	 System.out.println("observationalData: "+elementName+" "+elementValue);
...
else if ( elementCategory.equals("species") ) 
{
	 //store  the incomming species data in a temporary vector
		//System.out.println(elementValue);
		if (elementName.equals("taxonName") || elementName.equals("authNameId") ) 
		{
		...
		{
			//System.out.println("PASSED IN CUM STRATA COVER: "+elementValue);
