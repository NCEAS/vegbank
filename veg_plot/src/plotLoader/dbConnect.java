...
String connect_string = "jdbc:oracle:thin:@alpha.nceas.ucsb.edu:1521:oralin";
String login = "harris";
String passwd = "harris";
...
public void makeConnection(Connection conn, Statement query)
{
	...
	System.out.println("connecting to database using the string: "+connect_string);
