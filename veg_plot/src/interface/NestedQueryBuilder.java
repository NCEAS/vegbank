...
public class NestedQueryBuilder extends javax.swing.JFrame 
{
    ...
    public NestedQueryBuilder() 
		{
				...
				setTitle(" Vegetation DataBase Workbench -- Nested Query Module ");
        initComponents ();
        pack ();
        setSize(620, 350);
    }
    ...
    private void initComponents() 
      ...
      //operators array
			String [] queryOperatorElements = {"less than", "greater than", "equals", 
...
//			mainPane.add(queryLabelPane);
		 ...
		 private void handleQueryUpdate(ActionEvent evt) 
        	...
        	//this is a test to request data from a servlet at NCEAS
      		...
      		String protocol=(rb.getString("servletProtocol"));
				...
				{
					System.out.println("functionality not yet supported -- local query");
				}
				else 
				{
	...
	//				String host = "dev.nceas.ucsb.edu";
      		...
      		String protocol=(rb.getString("servletProtocol"));
				...
				//	String returnedData=( drc.requestURL(servlet, protocol, host, parameters) );
      		hv.show();
      		hv.showData("summary.xml",  "showSummary.xsl", "text/html");  
				}
				else if(localDatabaseTypeSelector.isSelected() == true )
				{
					System.out.println("functionality not yet supported -- local query");
