...
private void initComponents() {//GEN-BEGIN:initComponents
    ...
    setTitle(" Vegetation DataBase Workbench -- Simple Query Module");
   ...
   //get the properties out of the resource bundle
      ...
      if (jRadioButton1.isSelected() == true ) 
        ...
        hv.showData("summary.xml", "transformMultiPlotSummary.xsl", "text/html");
			...
			{
				System.out.println("** failed in: QueryModule: "
				+" "+e.getMessage());
			}
     } //end if
     ...
     else  
		{
      	...
      	hv.showData(returnedData);  
	 		...
	 		catch( Exception e ) 
			{
				...
				+" first try - anaylyzing the input parameters "
				+e.getMessage());
				}
      }	
