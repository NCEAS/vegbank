...
Vector siteFileVector = new Vector(); //vector to contain data from site file
Vector speciesFileVector = new Vector(); //vector to contain data from species file
...
catch ( Exception e ) {System.out.println("failed in: LegacyDataFormatter.readTNCData "
	+e.getMessage());}
}
...
catch ( Exception e ) {System.out.println("failed in: LegacyDataFormatter.parseTNCData "
	+" -- the second try"+e.getMessage());  e.printStackTrace();}
 ...
 *
 */
private void mapTNCElements (String outFileName)
{
