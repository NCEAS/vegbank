/*
 * '$Id: correlation_Action.java,v 1.1.1.1 2004-04-21 17:10:06 anderson Exp $'
 * 
...
public class correlation_Action extends org.apache.struts.action.Action
{

	public correlation_Action()
	{
		...
		HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		correlation_Form correlation_form=(correlation_Form)session.getAttribute("correlation_form");
		if(manager==null)
		{
		...
		if(correlation_form==null)
		{
			errors.add("Failed to find the FormBean:correlation_form");
			return (mapping.findForward("error"));
		}
