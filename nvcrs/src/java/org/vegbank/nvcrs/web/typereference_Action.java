/*
 * '$Id: typereference_Action.java,v 1.1.1.1 2004-04-21 17:10:07 anderson Exp $'
 * 
...
public class typereference_Action extends org.apache.struts.action.Action
{

	public typereference_Action()
	{
		...
		HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		typereference_Form typereference_form=(typereference_Form)session.getAttribute("typereference_form");
		if(manager==null)
		{
		...
		if(typereference_form==null)
		{
			errors.add("Failed to find the FormBean:typereference_form");
			return (mapping.findForward("error"));
		}
