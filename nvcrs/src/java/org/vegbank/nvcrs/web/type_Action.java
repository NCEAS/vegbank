/*
 * '$Id: type_Action.java,v 1.1.1.1 2004-04-21 17:10:07 anderson Exp $'
 * 
...
public class type_Action extends org.apache.struts.action.Action
{
		...
		HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		type_Form type_form=(type_Form)session.getAttribute("type_form");
		if(manager==null)
		{
		...
		if(type_form==null)
		{
			errors.add("Failed to find the FormBean:type_form");
			return (mapping.findForward("error"));
		}
