/*
 * '$Id: plot_Action.java,v 1.1.1.1 2004-04-21 17:10:06 anderson Exp $'
 * 
...
public class plot_Action extends org.apache.struts.action.Action
{
		...
		HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		plot_Form plot_form=(plot_Form)session.getAttribute("plot_form");
		if(manager==null)
		{
		...
		if(plot_form==null)
		{
			errors.add("Failed to find the FormBean:plot_form");
			return (mapping.findForward("error"));
		}
