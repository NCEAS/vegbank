/*
 * '$Id: lookup_roletype_Action.java,v 1.1.1.1 2004-04-21 17:10:06 anderson Exp $'
 * 
...
public class lookup_roletype_Action extends org.apache.struts.action.Action
{

	public lookup_roletype_Action()
	{
		...
		HttpServletRequest request, HttpServletResponse response) throws Exception
	{
		...
		lookup_roletype_Form lookup_roletype_form=(lookup_roletype_Form)session.getAttribute("lookup_roletype_form");
		if(manager==null)
		{
		...
		if(lookup_roletype_form==null)
		{
			errors.add("Failed to find the FormBean:lookup_roletype_form");
			return (mapping.findForward("error"));
		}
