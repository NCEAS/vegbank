...
<script language="javascript" >
	...
	{
		document.lookup_eventtype_form.action.value=act;
		document.lookup_eventtype_form.submit();
	}
...
%>
<center>
<h3>lookup_eventtype</h3>
<br><br>
<html:form action="/lookup_eventtype" onsubmit="return validate()" >
